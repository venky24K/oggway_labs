/**
 * TypeScript definitions and prompt templates for The Lenny Growth Assistant
 */
...
export interface QuickPromptItem {
  ...
  query: string;
  options?: {
    generate_ship30?: boolean;
    generate_artifact?: boolean;
  };
}

export interface PlaybookShortcut {
  id: string;
  title: string;
  icon: string;
  color: string;
...
export interface ConversationalStarter {
  label: string;
  query: string;
}

export const WELCOME_QUICK_CARDS: QuickPromptItem[] = [
  {
    id: "elena-verna-plg",
...
export const PLAYBOOK_SHORTCUTS: PlaybookShortcut[] = [
  {
    id: "plg-vs-slg",
...
export const CONVERSATIONAL_STARTERS: ConversationalStarter[] = [
  {
    label: "👋 Introduction",
